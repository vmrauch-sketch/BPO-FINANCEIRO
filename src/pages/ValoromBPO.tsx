              ...
              <div className="grid md:grid-cols-[280px_1fr] gap-10 items-start">
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="space-y-5 text-gray-300 leading-relaxed text-base md:text-lg">
                    ...
                    <p>
                      Foi atuando na gestão de empresas que Vilson construiu uma metodologia para organizar e integrar o financeiro. Um método validado na prática, com experiência em gestão, economia de empresas e contabilidade. Nada de teoria: processo definido, número conferido e relatório que o dono da empresa entende sem precisar de tradução.
                    </p>
                    <p>
