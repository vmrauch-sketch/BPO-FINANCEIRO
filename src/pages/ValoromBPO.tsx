        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-16">
              {[
                { num: "01.", title: "Serviço Para Todo Porte de Empresa", description: "Desde micro até grandes empresas e operações. A metodologia V1 da Valorum se adapta ao seu negócio e cresce junto com você.", highlight: false },
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
                As necessidades, o momento e os objetivos do seu negócio são <span className="text-white font-semibold">únicos</span> — por isso não trabalhamos com pacotes prontos. Criamos uma 
