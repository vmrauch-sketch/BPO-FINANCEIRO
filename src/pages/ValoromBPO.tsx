          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start max-w-6xl mx-auto">
              ...
              <div className="hidden md:block relative h-[420px] mt-8">
                ...
                <div className="absolute top-[140px] right-0 w-56 bg-[#1a1a2e]/90 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-5 shadow-2xl shadow-blue-500/10 animate-[float-down_3.5s_ease-in-out_infinite]">
                ...
                {/* Card 3 - EBITDA */}
                <div className="absolute top-[280px] right-12 w-48 bg-[#1a1a2e]/90 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-5 shadow-2xl shadow-blue-500/10 animate-[float-up_5s_ease-in-out_0.5s_infinite]">
