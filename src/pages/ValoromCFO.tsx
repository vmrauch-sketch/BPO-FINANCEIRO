          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-base md:text-lg text-gray-300 max-w-3xl mx-auto mb-3 leading-relaxed">
                Levamos para a sua organização as <span className="text-lime-400 font-semibold">entregas de excelência de um gestor financeiro empresarial</span> — otimizando a operação e capacitando o seu time para alta performance.
              </p>
              <p className="text-base md:text-lg text-gray-300 max-w-3xl mx-auto mb-3 leading-relaxed">
