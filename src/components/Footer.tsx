          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <button 
                ...
                className="flex items-center mt-4 text-white/60 hover:text-white transition-colors cursor-pointer text-sm"
              >
                <svg className="w-4 h-4 mr-2 text-financial-500" fill="currentColor" viewBox="0 0 24 24">
